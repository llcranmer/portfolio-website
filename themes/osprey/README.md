![Logo](https://github.com/http://toul.io//osprey/blob/master/images/osprey-logo.png)
...
## Screenshot
![Screenshot](https://github.com/http://toul.io//osprey/blob/master/images/tn.png)
...
```console
$ cd themes
$ git clone https://github.com/http://toul.io//osprey.git
```
...
```console
$ git submodule add https://github.com/http://toul.io//osprey.git themes/osprey
```
...
[Params]
    ...
    twitter = "http://toul.io/"
    linkedin = "http://toul.io/"
    github = "http://toul.io/"
    email = "touldeguiacranmer@gmail.com"
    googleTagManager = ""
    highlightJS = true
    copyright = true
    credit = true
...
color = "#7ac143"
link1 = "http://toul.io/.com"
link2 = "https://github.com/http://toul.io/"
+++
```
...
## License
This theme is released under the GNU 3.0 license. For more information read the [license](https://github.com/http://toul.io//osprey/blob/master/LICENSE).
